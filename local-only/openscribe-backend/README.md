<div align="center">
  <img src="website/public/openscribe-backend-logo-512.svg" alt="OpenScribe Logo" width="120" height="120">
...
<p align="center">
  <a href="https://github.com/sammargolis/OpenScribe/actions/workflows/build-release.yml"><img src="https://img.shields.io/github/actions/workflow/status/sammargolis/OpenScribe/build-release.yml?branch=main&style=for-the-badge" alt="Build"></a>
  <a href="https://github.com/sammargolis/OpenScribe/releases"><img src="https://img.shields.io/github/v/release/sammargolis/OpenScribe?style=for-the-badge" alt="Release"></a>
...
<div align="center">
  <img src="website/public/app-demo.png" alt="OpenScribe Interface" width="600">
...
- [Apple Silicon (M1/M2/M3/M4)](https://github.com/sammargolis/OpenScribe/releases/latest/download/stenoAI-macos-arm64.dmg)
- [Intel Macs](https://github.com/sammargolis/OpenScribe/releases/latest/download/stenoAI-macos-x64.dmg) Performance on Intel Macs is limited due to lack of dedicated AI inference capabilities on these older chips.
...
4. **To fix this warning:**
   ...
   **Alternatively:**
   - Right-click OpenScribe in Applications and select **"Open"**
   - Or run in Terminal: `xattr -cr /Applications/OpenScribe.app`
...
pyinstaller openscribe-backend.spec --noconfirm
...
OpenScribe includes a built-in debug panel for troubleshooting issues:
...
```bash
# Launch OpenScribe with full logging
/Applications/OpenScribe.app/Contents/MacOS/OpenScribe
```
...
```bash
# View recent OpenScribe-related logs
log show --last 10m --predicate 'process CONTAINS "OpenScribe" OR eventMessage CONTAINS "ollama"' --info

# Monitor live logs
log stream --predicate 'eventMessage CONTAINS "ollama" OR process CONTAINS "OpenScribe"' --level info
```
...
### Logs Location
- **User Data**: `~/Library/Application Support/openscribe-backend/`
- **Recordings**: `~/Library/Application Support/openscribe-backend/recordings/`
- **Transcripts**: `~/Library/Application Support/openscribe-backend/transcripts/`
- **Summaries**: `~/Library/Application Support/openscribe-backend/output/`
